...
__ALIGN_BEGIN static uint8_t HID_MOUSE_ReportDesc[HID_MOUSE_REPORT_DESC_SIZE]  __ALIGN_END =
{
	...
	0x91, 0x03,// OUTPUT (Cnst,Var,Abs)	//Ìî³äÎ»
	//
	0xc0, 
...
{
  /* Open EP IN */
  USBD_LL_OpenEP(pdev, HID_EPIN_ADDR, USBD_EP_TYPE_INTR, HID_EPIN_SIZE); //???Why
    ...
    case USB_REQ_TYPE_CLASS :
      switch (req->bRequest)
      {
        ...
        case HID_REQ_SET_REPORT:
          USBD_CtlPrepareRx(pdev, KeyboardOutData, req->wLength);
          break;
